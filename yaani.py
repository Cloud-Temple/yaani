...
class StackTransformer(Transformer):
    def __init__(self, stack_string, api_connector, import_namespace, sub_import_namespace):
...
class InventoryBuilder:
    ...
    def _execute_sub_import(self, sub_import, import_namespace, sub_import_namespace):
        # Extract stack string
        stack_string = sub_import['stack']

        # Extract vars definition
        vars_def = sub_import['vars']
    ...
    def _add_element_to_inventory(self, element_index, host_dict, inventory,
        ...
        self._add_element_to_group(
            element_name=element_index, group_name=obj_type, inventory=inventory
        )
        self._add_element_to_group(
    ...
    def _resolve_expression(self, key_path, build_ns, import_ns, sub_import_ns):
